...
public class CrudTransportController implements Initializable {
   ...
   // private ComboBox<TypeTransport> comoType;
    private    ComboBox<String> comoType = new ComboBox<>();
    @FXML
...
private Transport.TypeTransport transportType;
   Transport T = null;
...
// ...
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        colType.setCellValueFactory(new PropertyValueFactory<Transport, String>("transportType"));
 ...
 Alert alert2 = new Alert(Alert.AlertType.WARNING);
         ...
         for (Map.Entry ele : map.entrySet()) {
            if (ele.getValue().equals(comoAgence.getValue())) {
                ...
                st.ajouter(new Transport(idMatricule.getText(),comoType.getValue().toString() ,  Float.parseFloat(idPrix.getText()), Integer.parseInt(ele.getKey().toString())));
 ...
 Alert alert2 = new Alert(Alert.AlertType.WARNING);
            ...
            for (Map.Entry ele : map.entrySet()) {
                if (ele.getValue().equals(comoAgence.getValue())) {
                    ...
                    st.modifier(new Transport(T.getId(),idMatricule.getText(),comoType.getValue().toString()  ,Float.parseFloat(idPrix.getText()), Integer.parseInt(ele.getKey().toString())));
                }
            }
...
@FXML
  ...
  @FXML
    private void gestionmedecin(ActionEvent event) throws IOException {
        ...
        tableTransport.getScene().setRoot(root);
    }
