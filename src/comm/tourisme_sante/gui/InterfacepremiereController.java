 ...
 * @author LENOVO
 */
public class InterfacepremiereController implements Initializable {
    ...
    @FXML
    private void navigaterdv(ActionEvent event) throws IOException {
    ...
    @FXML
    private void navigatemedecin(ActionEvent event) throws IOException {
