...
public enum TypeTransport {
 ...
 public void settDisplayName(String displayName) {
   ...
   public Transport(int id, String matricule, TypeTransport transportType,float prix,int idAgence) {
        this.id = id;
        this.matricule = matricule;
  ...
  public Transport(int id, String matricule, String transport,float prix,int idAgence) {
    ...
    public Transport(String matricule, TypeTransport transportType,float prix,int idAgence) {
        this.matricule = matricule;
        this.transportType = transportType;
                this.prix=prix;
                this.idAgence=idAgence;
